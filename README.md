...
**_`<script src="https://cdn.jsdelivr.net/npm/iri-widget@0.0.0/dist/index.min.js"></script>`_**
...
```html
<script src="https://cdn.jsdelivr.net/npm/iri-widget@0.0.0/dist/index.min.js"></script>
```
